...
obj.COST_GPS_STATION2 = (Date.now() - tGPS_STATION2) / 1000;
...
if (config.runsInWidget || SILENT_RUN) {
  ...
  w.url = "scriptable:///run?scriptName=LRT_Timer29D19&silent=true";
  ...
  const COST_tAPI21=COST_tAPI20*4.0;
  const COST_tPARSE20=Number(obj.COST_tPARSE2)|| 0;  
  const result20=COST_GPS_STATION20+COST_tAPI21+COST_tPARSE20+5.0;
  obj.TOTAL1=result20;
